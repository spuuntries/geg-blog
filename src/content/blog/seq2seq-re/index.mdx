...
The results?
![A table of metrics, showing the chosed finetuned model to be higher than the baseline, at BLEU score of 52.35 ± 3.72, ROUGE-1 of 0.062, ROUGE-2 of 0.023, ROUGE-L of 0.056 ± 0.00075, and Weighted F1 of 0.438 ± 0.002.](./fptable.png)
